...
urlpatterns = [
    ...
    path('butterflies/', views.butterfly_list, name='butterfly_list'),
    path('butterflies/<slug:slug>/', views.butterfly_detail, name='butterfly_detail'),
    path('gallery/butterfly/<int:butterfly_id>/', views.butterfly_gallery, name='butterfly_gallery'),
